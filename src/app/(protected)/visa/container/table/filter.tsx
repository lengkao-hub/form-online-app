...
export function DataTableToolbar({ updateSearch, filter: { statusFilter, setStatusFilter, districtId, setProvinceId } }: DataTableToolbarProps) {
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex flex-1 flex-col-reverse items-start gap-y-2 sm:flex-row sm:items-center sm:space-x-2">
        ...
        />
        <Combobox options={districtOptions} placeholder="ເມືອງ" className="w-[150px] lg:w-[250px]" onChange={(value) => { handleProvince(value as number); }} value={districtId} />
