...
import { forwardRef, useEffect, useState, type ComponentPropsWithoutRef, type ElementRef } from "react"
import {
  Button,
  Command,
  CommandEmpty,
...
type MultiSelectProps = Omit<ComponentPropsWithoutRef<typeof Command>, "onChange" | "onValueChange" | "value"> & {
  options?: Option[]
  placeholder?: string
  emptyMessage?: string
...
export const MultiSelectCombobox = forwardRef<ElementRef<typeof Command>, MultiSelectProps>(
  (
    {
      options = [],
      placeholder = "Select...",
